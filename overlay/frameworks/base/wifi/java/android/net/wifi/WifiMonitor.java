...
public class WifiMonitor {
    ...
    private static final String WIFI_LED_PATH = "/sys/class/leds/RF_LED/brightness";
   ...
   /* Network connection completed */
    ...
    class MonitorThread extends Thread {
	    ...
	    Log.e(TAG, "Opening WIFI LED device.");
	    File f = new File(WIFI_LED_PATH);
	    OutputStream led = null;
	    try {
		led = new OutputStream(f);
	    } catch(java.io.IOException e) {
		Log.e(TAG, "Failed to open WIFI LED device.");
	    }
			...
			Log.e(TAG, "Failed to turn off WIFI status LED.");
		    }
                    break;
			...
			Log.e(TAG, "Failed to turn on WIFI status LED.");
		    }
                    break;
