...
class RotationSwitchObserver extends UEventObserver {
    private static final String TAG = RotationSwitchObserver.class.getSimpleName();
    private static final boolean LOG = true;

    private static final String LOCK_UEVENT_MATCH = "DEVPATH=/devices/virtual/switch/SW_ORIENT_HOLD";
    private static final String LOCK_STATE_PATH = "/sys/class/switch/SW_ORIENT_HOLD/state";
    ...
    private final void init() {
        ...
        try {
            ...
            file.close();
            mPreviousLockState = mLockState = Integer.valueOf((new String(buffer, 0, len)).trim());
